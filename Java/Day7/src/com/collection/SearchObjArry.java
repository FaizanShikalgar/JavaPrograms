...
public class SearchObjArry 
{
	...
	public static void main(String[] args) 
	{
		...
		/* the Comparable.compareTo() can be implement 
		 * to have only one Search so the Search it with the new
		 *  Criteria you need to use the 
		 *  Comparator.compare.and to use it you need 
		 *  to sort the array with the
		...
		System.out.println("\n three="
		+Arrays.binarySearch(sa,"three",rs));
