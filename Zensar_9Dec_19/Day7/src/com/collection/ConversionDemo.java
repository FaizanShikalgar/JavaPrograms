...
import java.util.*;
/* this demo demonstrates the Converting Array
 *  in to a list by asList() which is part of Arrays class and 
 * Converting the List in to a array by toArray()
 *  which is part of set and list classes*/
